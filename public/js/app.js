...
// 	  const headers = { "Content-Type": "application/json", ...API_VERSION_HEADER };
// 	  if (tokens) {
...
// 	  if (existing?.className === "pagination") existing.remove();
...
(function () {
	...
	// ── API Client ────────────────────────────────────
	// No token management needed — browser sends cookies automatically
	...
	async function checkAuth() {
	  // ✅ No need to read URL params — cookies are sent automatically
